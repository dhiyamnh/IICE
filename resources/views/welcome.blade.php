...
<head>
    ...
    <title>Admin Login - UNITEN</title>
    ...
    <style>
        ...
        :root {
            /* Main Colors */
            --primary: #0F4C81;    /* UNITEN Dark Blue */
            --secondary: #CC0000;  /* Malaysian Red */
            --gold: #E8B730;   /* UNITEN Gold */
        ...
        body {
            ...
            color: var(--dark);
            background: url('img/carousel_1.jpg') no-repeat center center fixed;
...
<body>
    ...
    <div class="login-header">
        <div class="logo-container">
            <img src="img/iice.png" alt="UNITEN Logo">
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Focus on email field if not authenticated
            @guest
                setTimeout(() => {
                    $('#email').focus();
                }, 500);
